    ...
    return (
        <>
            ...
            <p>We are a platform that provides all the current adoption animals. On our website, you can save animals
                ...
                <Link to="/adoption"><b> adoption procedure</b></Link>. For more information or to get in touch, please
                visit our <Link to="/contact"><b> contact page</b></Link>.</p><br/>

            <p>Come and check out our current <Link to="/app/library"><b>adoption animals</b></Link>.</p>
